...
public class GlacierFossilsFeature extends Feature<NoFeatureConfig> {
    ...
    public GlacierFossilsFeature(Codec<NoFeatureConfig> p_i231955_1_) {
        super(p_i231955_1_);
    }
    ...
    public boolean func_230362_a_(ISeedReader p_230362_1_, StructureManager p_230362_2_, ChunkGenerator p_230362_3_, Random p_230362_4_, BlockPos p_230362_5_, NoFeatureConfig p_230362_6_) {
        Block block = p_230362_1_.getBlockState(p_230362_5_).getBlock();
        if (p_230362_5_.getY() <= 72 && (block == Blocks.PACKED_ICE || block == Blocks.BLUE_ICE || block == Blocks.SNOW_BLOCK || block == FrostburnExpansionBlocks.BOREALENE.get())) {
