...
public class BriskNearestAttackableTargetGoal<T extends LivingEntity> extends TargetGoal {
	   ...
	   public BriskNearestAttackableTargetGoal(MobEntity goalOwnerIn, Class<T> targetClassIn, boolean checkSight) {
	      this(goalOwnerIn, targetClassIn, checkSight, false);
	   }

	   public BriskNearestAttackableTargetGoal(MobEntity goalOwnerIn, Class<T> targetClassIn, boolean checkSight, boolean nearbyOnlyIn) {
	      this(goalOwnerIn, targetClassIn, 10, checkSight, nearbyOnlyIn, (Predicate<LivingEntity>)null);
	   }

	   public BriskNearestAttackableTargetGoal(MobEntity goalOwnerIn, Class<T> targetClassIn, int targetChanceIn, boolean checkSight, boolean nearbyOnlyIn, @Nullable Predicate<LivingEntity> targetPredicate) {
	   ...
	   public boolean shouldExecute() {
		  BriskEntity brisk = (BriskEntity) this.goalOwner;
		  if (brisk.isDancing) {
			  return false;
		  }
