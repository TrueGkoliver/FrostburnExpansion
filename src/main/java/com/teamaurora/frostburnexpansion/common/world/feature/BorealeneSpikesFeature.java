...
public class BorealeneSpikesFeature extends Feature<NoFeatureConfig>{

	public BorealeneSpikesFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn) {
	               ...
	               for(int j1 = -l; j1 <= l; ++j1) {
	                  ...
	                  if ((i1 == 0 && j1 == 0 || !(f1 * f1 + f2 * f2 > f * f)) && (i1 != -l && i1 != l && j1 != -l && j1 != l || !(rand.nextFloat() > 0.75F))) {
	                     ...
	                     if (blockstate.isAir(worldIn, pos.add(i1, k, j1)) || isDirt(block) || block == Blocks.SNOW_BLOCK || block == Blocks.ICE) {
	                        this.setBlockState(worldIn, pos.add(i1, k, j1), FrostburnExpansionBlocks.BOREALENE.get().getDefaultState());
	                     }
