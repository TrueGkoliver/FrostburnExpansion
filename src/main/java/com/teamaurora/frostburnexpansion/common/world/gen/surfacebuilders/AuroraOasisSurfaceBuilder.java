...
public class AuroraOasisSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {
    public AuroraOasisSurfaceBuilder(Function<Dynamic<?>, ? extends SurfaceBuilderConfig> function) {
        super(function);
    }
        ...
        for(int i1 = startHeight; i1 >= 0; --i1) {
            ...
            if (blockstate2.isAir()) {
                ...
                if (i == -1) {
                    ...
                    if (i == 0 && (blockstate1.getBlock() == Blocks.GRASS_BLOCK || blockstate1.getBlock() == Blocks.DIRT) && j > 1) {
                        i = random.nextInt(4) + Math.max(0, i1 - 63);
                        blockstate1 = FrostburnExpansionBlocks.BOREALENE.get().getDefaultState();
                    }
                }
            }
        }
